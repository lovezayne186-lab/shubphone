...
格式如下：
{
  "thought": "你的内部结构化思考，用于判断当前轮对话的真实意图和规划行动，可以简洁，不必追求文艺感，不要写给用户看的套话。",
  "reply": "发送给用户的文本。如果因忙碌或睡觉无法回复，必须填 null。",
  "system_event": "仅在 reply 为 null 时填写，例如 '对方开启了勿扰模式' 或 '对方正忙'，否则填 null。",
  "status": {
    "mood": "当前心情状态，例如 兴奋、害羞、放松。",
    "location": "当前所在地点或场景，例如 她的房间、卧室床上。",
    "fantasy": "此刻脑海中的简短画面或性幻想描述。",
...
let finalSystemPrompt = 
    ...
    "=== TRANSFER PROTOCOL ===\n" +
    "当你决定进行虚拟转账时，请在 JSON 的 actions.transfer 字段中返回金额和备注。\n" +
    "示例: 在 actions.transfer 中填 { amount: 50, remark: '拿去花' }。\n";
