...
function appendMessageToDOM(msg) {
    ...
    bindMessageLongPressEdit(row, msg);
...
function openUserPersonaModal() {
    ...
    const birthdayInput = document.getElementById('user-settings-birthday');
    ...
    if (birthdayInput) birthdayInput.value = myPersona.birthday || "";
    if (birthdayTypeSelect) birthdayTypeSelect.value = myPersona.birthdayType || "solar";
